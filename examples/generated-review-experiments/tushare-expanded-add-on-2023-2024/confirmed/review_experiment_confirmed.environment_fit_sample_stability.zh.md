...
- run_id: `tushare-expanded-add-on-2023-2024__review__environment_fit_sample_stability`
- confirmed_by: `codex`
...
strategy:
  ...
  sizing_params:
    max_holding_count: 5
    max_position_percent: 0.18
    max_total_exposure_percent: 0.9
    max_risk_group_exposure_percent: 0.3
    cash_reserve_percent: 0.05
    max_turnover_percent: 0.35
    risk_group_level: 1
