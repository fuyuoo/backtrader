...
_ARTIFACT_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "fields": [
            ...
            {"path": "closed_trades[].entry_gross_value", "meaning_zh": "本轮交易累计买入成交额，用于整笔交易收益口径。"},
            {"path": "closed_trades[].exit_gross_value", "meaning_zh": "本轮交易累计卖出成交额，包含分批减仓和最终清仓。"},
            {"path": "closed_trades[].net_pnl", "meaning_zh": "整笔交易卖出总额减买入总额的净价差结果；当前为前复权价差模拟口径。"},
            {"path": "closed_trades[].realized_return_pct", "meaning_zh": "整笔交易收益率，按 net_pnl / entry_gross_value 计算，包含中途分批减仓现金流。"},
